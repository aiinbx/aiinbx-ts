...
import { ClientOptions } from 'ai-inbx';
...
export { ClientOptions } from 'ai-inbx';
...
export function initMcpServer(params: {
  ...
  const client = new AIInbx(params.clientOptions);
  const capabilities = {
    ...defaultClientCapabilities,
...
export function init(params: {
  ...
  const client = params.client || new AIInbx({ defaultHeaders: { 'X-Stainless-MCP': 'true' } });
